...
| `RMAPI_HWR_HOST`           | Optional: Custom myScript host URL (default: `https://cloud.myscript.com`). Supports http/https protocols and custom ports (e.g., `https://custom.myscript.com:8443`) |
